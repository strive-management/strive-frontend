        ...
        {isOutletActive ? (
          ...
          <div className="flex flex-grow pt-20">
            <div
              ...
              className="flex flex-col items-center top-20 p-5 sm:p-10 gap-6 overflow-auto sm:left-20 md:left-40 md:grid md:grid-cols-2 lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto"
            >
              <div className="flex flex-row items-center place-content-center text-3xl top-0 z-10 h-20 w-full text-gray-600 dark:text-gray-300">
                <div className="mt-0">Dashboard</div>
              </div>
              <div className="flex flex-col items-center content-center text-center p-6 w-11/12 top-20 border-2 border-gray-500 dark:border-gray-300 rounded-xl text-2xl text-gray-600 dark:text-gray-300">
                <DateAndTime />
                <StaffTracking />
              </div>
              <div className="flex flex-col items-center content-center text-center p-6 w-11/12 top-20 border-2 border-gray-500 dark:border-gray-300 rounded-xl text-2xl text-gray-600 dark:text-gray-300">
