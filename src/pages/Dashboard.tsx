      ...
      <div className='flex flex-row h-screen w-full bg-gray-100 dark:bg-[#212020]'>
        ...
        {isOutletActive ? (
          ...
          <div
            ...
            className='flex flex-col items-center top-20 p-5 sm:p-10 h-screen gap-6 overflow-auto bg-white dark:bg-[#212020] sm:left-20 md:left-40 md:grid md:grid-cols-2 lg:max-w-6xl xl:max-w-7xl 2xl:max-w-8xl mx-auto'
          >
