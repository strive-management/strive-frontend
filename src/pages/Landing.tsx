...
const Landing: React.FC = () => {
  ...
  return (
    <>
      ...
      <header className="fixed z-20 w-full">
          ...
          <nav className="fixed w-full backdrop-blur-md bg-white/80 text-gray-800 h-30 dark:bg-[#1a0429]/80 drop-shadow dark:text-gray-300">
            <div className="flex items-center justify-between mx-6 sm:flex sm:flex-row sm:justify-between">
              ...
              <div style={{ fontFamily: "'Rubik', sans-serif", fontSize: "large" }} className='sm:flex sm:place-items-center sm:flex-row sm:items-center'>
                ...
                <div className='place-content-end'><BurgerMenu /></div>
              </div>
              <div style={{ fontFamily: "'Rubik', sans-serif", fontSize: "large" }} className='hidden sm:flex sm:flex-row sm:place-items-center'>
      ...
      <section id='hero' className='flex mt-32 sm:mt-0 w-[1400px] max-w-[2000px] items-center relative'>
        ...
        <div style={{ fontFamily: "'Rubik', sans-serif" }} className='absolute place-items-center justify-center left-0 w-full h-full flex z-10'>
          <div className="flex flex-col px-8 py-8 border-solid border-2 border-[#c0f2fc] bg-white/80 dark:border-[#75c479] dark:bg-[#2c292e] rounded-xl place-items-center"><p className='text-gray-700 dark:text-gray-300 text-xl sm:text-6xl'>Strive Management Solutions</p></div>
        </div>
      </section>
      </main>
    ...
    <div className='py-10 w-full max-w-[1400px]'>
        <div className='grid grid-cols-1 sm:grid-cols-2 place-items-center gap-8 auto-rows-[200px] font-rubik text-4xl'>
            <div className="flex flex-col py-8 w-full border-solid border-2 border-[#c0f2fc] bg-white dark:border-[#75c479] dark:bg-[#2c292e] rounded-xl place-items-center"><h1 className='text-3xl sm:text-4xl'>Fast</h1><img src={bolt} alt="logo-dark" className='w-10 h-10 block dark:hidden'/></div>
            <div className="flex flex-col py-8 w-full border-solid border-2 border-[#c0f2fc] bg-white dark:border-[#75c479] dark:bg-[#2c292e] rounded-xl place-items-center"><h1 className='text-3xl sm:text-4xl'>Simple</h1><img src={celebrate} alt="logo-dark" className='w-10 h-10 block dark:hidden'/></div>
            <div className="flex flex-col py-8 w-full border-solid border-2 border-[#c0f2fc] bg-white dark:border-[#75c479] dark:bg-[#2c292e] rounded-xl place-items-center"><h1 className='text-3xl sm:text-4xl'>Efficient</h1><img src={spa} alt="logo-dark" className='w-10 h-10 block dark:hidden'/></div>
            <div className="flex flex-col py-8 w-full border-solid border-2 border-[#c0f2fc] bg-white dark:border-[#75c479] dark:bg-[#2c292e] rounded-xl place-items-center"><h1 className='text-3xl sm:text-4xl'>Secure</h1><img src={lock} alt="logo-dark" className='w-10 h-10 block dark:hidden'/></div>
        </div>
    </div>
</section>
      <div className="flex justify-center py-16 bg-[#fbf7fc] dark:bg-[#1a0429]">
      ...
      <footer style={{ fontFamily: "'Rubik', sans-serif" }} id="footer" className="bg-[#fbf7fc] dark:bg-[#1a0429] sm:mx-auto flex w-full sm:max-w-[2000px] justify-center sm:justify-center relative text-gray-700 dark:text-gray-300 sm:p-10 flex-col sm:flex-row text-base h-40">
          <div className='flex flex-col sm:flex-row sm:w-full sm:max-w-[2000px] relative sm:justify-between'>
            ...
            <br/>
            <p className="text-center">Copyright &copy; <span id="year">2024</span></p>
